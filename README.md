...
1.) The first thing you are going to do is create a virtual machine by going to https://portal.azure.com/. Setup your virtual machine with Windows 10 Pro, version 21H2. Note, you will want to create a virtual machine with atleast 2 vcpus and 16 gbs of memory.
